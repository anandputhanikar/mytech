 ...
 */
public class PrimeNumBySquareRoot {
    public static void main(String args[]) {
        ...
        while (number != 0) {
            number = scnr.nextInt();
            System.out.printf("Does %d is prime? %s %s %s %n", number, isPrime(number),
                    isPrimeOrNot(number), isPrimeNumber(number));
        }
    }
    ...
    public static boolean isPrime(int number) {
        ...
        return true;
            ...
            /* * Second version of isPrimeNumber method, with improvement like not * checking for division by even number,
